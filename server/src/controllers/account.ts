...
import {
  ...
  changePasswordWithSupabaseSession,
...
function handleAccountError(res: Response, error: unknown, fallbackMessage: string) {
...
export async function updateProfileController(req: Request, res: Response) {
  try {
    ...
    const input = validateProfileUpdateInput((req.body || {}) as Record<string, unknown>);
...
export async function changePasswordController(req: Request, res: Response) {
  try {
    ...
    const input = validatePasswordChangeInput((req.body || {}) as Record<string, unknown>);
...
export async function forgotPasswordController(req: Request, res: Response) {
  try {
    const input = validateForgotPasswordInput((req.body || {}) as Record<string, unknown>);
...
export async function resetPasswordController(req: Request, res: Response) {
  try {
    const input = validateResetPasswordInput((req.body || {}) as Record<string, unknown>);
